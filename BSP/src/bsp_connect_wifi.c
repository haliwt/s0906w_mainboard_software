    ...
    switch(g_wifi.wifi_get_beijing_step){
     ...
     case 0: //WT.EDIT .2024.08.10
      ...
      if(g_wifi.gwifi_link_net_success==1 && g_wifi.gTimer_get_data_from_tencent_data > 9){ ////9
        ...
        if(flag_switch > 5 && g_pro.gpower_on == power_on){ //100ms
             flag_switch=0;
   ...
   case 1:
        ...
        if(g_wifi.gTimer_get_beijing_time > 65 ){//WT.EDIT 2025.01.06 // 65s after repeat auto connect net .
         ...
         g_wifi.gTimer_get_beijing_time=0;
          ...
          if(g_wifi.gwifi_link_net_success==1){
                ...
                if(g_pro.disp_second_f ==1){
					SendWifiData_To_Cmd(0x1F,0x0);//SendWifiData_One_Data(0x1F,0x0); //0x1F: 0x1=wifi link net is succes ,0x0 = wifi link net is fail
               tx_thread_sleep(10);
                	}
    ...
    case 10:
     ...
     case 12:
        ...
        if(g_wifi.gTimer_auto_link_net_time > 3 && auto_link_net_flag==1){
