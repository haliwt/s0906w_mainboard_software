...
//#define  LED_WIFI_TOGGLE         do{LED_WIFI_GIOP_Port ->ODR ^= LED_WIFI_Pin;}while(0)
...
#define LED_TEMP_ICON_ON()     do{LED_TEMP_GPIO_Port->BSRR =(uint32_t)LED_TEMP_Pin;}while(0)//        sys_write_gpio_pin_value(LED_TEMP_SYMBOL_GPIO_Port, LED_TEMP_SYMBOL_Pin, GPIO_PIN_RESET)
#define LED_TEMP_ICON_OFF()    do{LED_TEMP_GPIO_Port->BSRR =LED_TEMP_Pin;}while(0)      //sys_write_gpio_pin_value(LED_TEMP_SYMBOL_GPIO_Port, LED_TEMP_SYMBOL_Pin, GPIO_PIN_SET)
...
#define LED_PLASMA_ON()         do{LED_PLASMA_GPIO_Port->BSRR =(uint32_t) LED_PLASMA_Pin << 16;}while(0)//sys_write_gpio_pin_value(LED_PLASMA_GPIO_Port, LED_PLASMA_Pin, GPIO_PIN_RESET)
#define LED_PLASMA_OFF()        do{LED_PLASMA_GPIO_Port ->BSRR = LED_PLASMA_Pin;}while(0)//sys_write_gpio_pin_value(LED_PLASMA_GPIO_Port, LED_PLASMA_Pin, GPIO_PIN_SET)

#define LED_MOUSE_ON()          do{LED_MOUSE_GPIO_Port ->BSRR =(uint32_t)LED_MOUSE_Pin <<16;}while(0)//sys_write_gpio_pin_value(LED_MOUSE_GPIO_Port, LED_MOUSE_Pin, GPIO_PIN_RESET)
#define LED_MOUSE_OFF()         do{LED_MOUSE_GPIO_Port ->BSRR = LED_MOUSE_Pin;}while(0)//sys_write_gpio_pin_value(LED_MOUSE_GPIO_Port, LED_MOUSE_Pin, GPIO_PIN_SET)
